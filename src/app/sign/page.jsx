...
export default function Sign() {
  ...
  return (
    <div className='flex justify-center items-center h-screen'>
        ...
        {/* sign in  */}
        {/* sign in form */}
        <div className='flex justify-center items-center shadow-lg shadow-rose-700/50 w-11/12 sm:w-4/5 max-h-min rounded-xl
                    text-gray-300'
                        style={{backgroundColor: '#0d0d0f'}}>
            
            <div className='absolute top-3 flex justify-center items-center gap-5 cursor-pointer'>
            ...
            <div className={`${signInForm} w-full lg:w-1/2 fadeIn`} >
                <form action="" className='flex flex-col justify-center items-center mx-4 sm:mx-8 py-20 gap-5'>
                    ...
                    <div className='flex gap-4'>
                        <FaGoogle className='text-blue-800 hover:text-rose-700 w-8 h-8' />
                        <FaFacebookSquare className='text-blue-800 hover:text-rose-700 w-8 h-8'/>
                    </div>
                    ...
                    <button className='font-bold text-sm  bg-blue-950 py-3 px-12 lg:w-3/5 md:w-2/5 sm:w-3/5 w-52 rounded-3xl text-white hover:bg-rose-700'>SIGN IN</button>
            ...
            <div className= {`${signIn} w-1/2 signUpForm`}>
                <div className="flex flex-col justify-center items-center px-10 py-6 gap-7 text-center" >
                    ...
                    <button onClick={signInButton} className='border-solid border-2 border-blue-950 rounded-3xl py-2 px-12 text-sm hover:border-rose-700'>SIGN UP</button>
                </div>
            </div>
            ...
            <div className={`${signUp} w-full lg:w-1/2 signInForm`}>
                <div className="flex flex-col justify-center items-center px-10 py-6 gap-7 text-center" >
                    <h1 className='text-4xl font-bold'>Hello, Client!</h1>
                    <h1>Enter your personal details and start journey with us</h1>
                    <button onClick={signUpButton} className='border-solid border-2 border-blue-950 rounded-3xl py-2 px-12 text-sm hover:border-rose-700'>SIGN IN</button>
                </div>
            </div>
            ...
            <div className={`${signUpForm} w-full lg:w-1/2 fadeIn`} >
                <form action="" className='flex flex-col justify-center items-center  mx-4 sm:mx-8 py-20 gap-5'>
                    ...
                    <button className='font-bold text-sm  bg-blue-950 py-3 px-12 lg:w-3/5 md:w-2/5 sm:w-3/5 w-52 rounded-3xl text-white hover:bg-rose-700'>SIGN UP</button>
