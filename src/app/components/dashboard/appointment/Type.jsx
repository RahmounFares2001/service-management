  ...
  return (
    <div className='w-full h-full flex justify-center'>
      <div className='w-11/12 sm:w-10/12 lg:w-4/5 h-full text-gray-200 flex flex-col gap-7 items-center pt-5 sm:pt-10 pb-20 sm:pb-0'>
        ...
        <h1 className='text-center text-xl sm:text-2xl font-bold text-black'>Chose the date of your appointment</h1>
    

        <div className='flex gap-4 xl:gap-7 2xl:gap-10 w-5/6 justify-center items-center  flex-col md:flex-row'>
          {/* on site btn */}
          <button className={`px-6 sm:px-8 py-3 xl:px-14 xl:py-3 w-full sm:w-3/5 md:w-auto transition-colors duration-300
