      ...
      <TableRow>
        ...
        {headCells.map((headCell) => (
          <TableCell
            ...
            sx={{fontSize: '1rem', '@media (max-width: 510px)': {fontSize: '0.7rem'}, color: 'white'}}
          >
            <TableSortLabel
    ...
    >
      ...
      {numSelected > 0 ? (
        <Tooltip title="Delete">
          <IconButton>
            <MdDeleteOutline className='text-gray-200' />
          </IconButton>
        </Tooltip>
      ) : (
        <Tooltip title="Filter list">
          <IconButton>
            <CiFilter className='text-gray-200' />
          </IconButton>
        </Tooltip>
      )}
    </Toolbar>
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="right" sx={{fontSize: '1rem', '@media (max-width: 510px)': { fontSize: '0.7rem' },
                          color: 'white'}} >{row.number}</TableCell>

                    <TableCell align="right" sx={{fontSize: '1rem', '@media (max-width: 510px)': { fontSize: '0.7rem' },
                          color: 'white'}}>{row.type}</TableCell>

                    <TableCell align="right" sx={{fontSize: '1rem', '@media (max-width: 510px)': { fontSize: '0.7rem' },
                          color: 'white'}}>{row.date}</TableCell>

                    <TableCell align="right" sx={{fontSize: '1rem', '@media (max-width: 510px)': { fontSize: '0.7rem' },
                          color: 'white'}}>{row.status}</TableCell>
                  </TableRow>
                );
              })}
              {emptyRows > 0 && (
