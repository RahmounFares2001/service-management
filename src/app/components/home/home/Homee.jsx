...
export default function Home() {
  return (
    <section className='text-gray-300 flex gap-20 xl:gap-32 pt-20 justify-center items-center pb-24' >
      ...
      <div className='flex flex-col gap-7 justify-center'>
        ...
        <div className='flex justify-center lg:justify-start w-full'>
          <p className='lg:w-96 w-4/5 '>We build personalized websites and mobile apps using the latest technologies, ensuring client satisfaction and timely delivery for an enhanced digital presence.</p>
        </div>
